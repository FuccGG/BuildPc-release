...
def no_empty_fields(player_action_model):
    to_check = [player_action_model.power_supply, player_action_model.cooling, player_action_model.ram,
                ...
                player_action_model.hdd, player_action_model.video_card, player_action_model.ssd]
    for p in to_check:
        if p is None:
            return False
    return True
...
# Cooling supports several sockets which must be inputted as string, separated by blank spaces and commas in database
